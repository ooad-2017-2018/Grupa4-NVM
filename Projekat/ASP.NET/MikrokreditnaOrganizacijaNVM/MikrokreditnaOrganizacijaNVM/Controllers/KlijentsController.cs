...
namespace MikrokreditnaOrganizacijaNVM.Controllers
{
    public class KlijentsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Plata,fourSqaureId,Ime,Prezime,JMBG,BrTel,Adresa,Username,Password")] Klijent klijent)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Plata,fourSqaureId,Ime,Prezime,JMBG,BrTel,Adresa,Username,Password")] Klijent klijent)
        {
            if (ModelState.IsValid)
            {
